...
export class DescriptionComponent implements OnInit {
  ...
  products = [
    ...
    {
      id: '31111022',
      image: 'assets/images/sac-enfant-fille1.png',
      title: 'SAC FILLE:',
      description: 'Sac à main fille',
      price: '30DT',
      colors: 'Beige, Noir, Rouge, Blanc',
      size: 'Unique'
    },
    {
      id: '2255555',
      image: 'assets/images/sac-enfant-fille2.png',
      title: 'SAC FILLE:',
      description: 'Sac à dos fille tendance',
      price: '80DT',
      colors: 'Blanc, Noir, Bleu, Violet, Rose',
      size: 'Unique'
    },
    {
      id: '1299912',
      image: 'assets/images/sac-enfant-fille3.png',
      title: 'SAC FILLE:',
      description: 'Sac à dos fille',
      price: '50DT',
      colors: 'Beige, Noir, Blanc, Bleu',
      size: 'Unique'
    },{
    ...
    {
      id: 'mp11022',
      image: 'assets/images/sac-bebe-fille1.png',
      title: 'SAC Bébé FILLE:',
      description: 'Sacs bébé fille',
      price: '35DT',
      colors: 'Beige, Noir, Rouge, Blanc',
      size: 'Unique'
    },
    {
      id: 'nbvl55555',
      image: 'assets/images/sac-bebe-fille2.png',
      title: 'SAC Bébé FILLE:',
      description: 'Sac fille pour nouveau né',
      price: '39.900DT',
      colors: 'Blanc, Noir, Bleu, Violet, Rose',
      size: 'Unique'
    },
    {
      id: 'azeo99912',
      image: 'assets/images/sac-bebe-fille3.png',
      title: 'SAC Bébé FILLE:',
      description: 'Sac fille pour nouveau né',
      price: '39.900DT',
      colors: 'Beige, Noir, Blanc, Bleu',
